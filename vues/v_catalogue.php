...
<div id="catalogue">
    Ceci est la page catalogue
    <table>
        <!-- modifier le format de l'heure et de la date -->
        <tr><th>Numéro de vol</th><th>Aéroport de départ</th><th>Aéroport d'arrivée</th><th>Date de départ</th><th>Date d'arrivé</th><th>Prix</th><th>Nombre de places Restantes</th></tr>
        <?php
