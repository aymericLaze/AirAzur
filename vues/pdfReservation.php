...
//Titre
    ...
    $pdf->Ln(20);
//Affiche le numero de reservation et le cadre
    ...
    $pdf->Ln();
    $pdf->Line($pdf->GetX(), $pdf->GetY() - 5, $pdf->GetX(), $pdf->GetY() + 300);
//Affiche le informations du vol
    $pdf->Cell(0);
    $pdf->Ln(10);
    ...
    $pdf->Cell(0);
    $pdf->Ln(10);
//Affiche les informations de la reservation
